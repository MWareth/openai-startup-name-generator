...
description: Investment-strategy analyst. Evaluates a property across buy-and-hold, BRRRR, and fix-and-flip with feasibility scores, multi-year projections, and break-even/ROI analysis. Use for investment-property decisions. Educational/research use only — not financial advice.
---
