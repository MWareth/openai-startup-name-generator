...
description: Rental-income analyst. Estimates market rent from comparable rentals and models cash flow, cap rate, and key investment metrics across conservative/moderate/optimistic scenarios. Use for income-property and cash-flow questions. Educational/research use only — not financial advice.
---
