  ...
  return (
    <div className="stack">
      ...
      <details className="card panel" open>
        <summary><h2>New launches</h2></summary>
        <div className="panel-body">
      ...
      {/* ---- Lead pool ---- */}
      <details className="card panel">
        <summary><h2>Lead pool</h2><span className="badge role">{poolLeads.length} available</span></summary>
        <div className="panel-body">
      ...
      {/* ---- Reassign leads ---- */}
      <details className="card panel">
        <summary><h2>Reassign leads</h2></summary>
        <div className="panel-body">
      ...
      {/* ---- Team & new members ---- */}
      <details className="card panel">
        <summary><h2>Team &amp; new members</h2></summary>
        <div className="panel-body">
          <table>
      ...
      {/* ---- Targets & incentives ---- */}
      <details className="card panel">
        <summary><h2>Targets &amp; incentives</h2></summary>
        <div className="panel-body">
          <h3>Set a target</h3>
      ...
      {/* ---- Projects directory ---- */}
      <details className="card panel">
        <summary><h2>Projects directory</h2></summary>
        <div className="panel-body">
          <div className="spread">
          ...
          <form action={createProject} style={{ marginTop: 12 }}>
            <div className="form-grid">
